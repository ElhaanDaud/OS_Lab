/*Learning Objective: To understand how to implement SCAN Disk Scheduling Algorithm. 
Task: Write a C program to implement SCAN Disk Scheduling Algorithm with initial head position at 53 and disk size as 200 for the below sectors: 
...
void scanDiskScheduling(int requests[], int num_requests, int initial_head, int disk_size) {
    ...
    // If the head is not at the end, move to the end of the disk
...
int main() {
    ...
    scanDiskScheduling(requests, num_requests, initial_head, disk_size);
